...
- **Key Features & Concepts (Know the 3 types):**
    - **File Gateway:** Presents an SMB or NFS file share on-prem, backed by S3.
    - **Volume Gateway:** Presents iSCSI block storage on-prem, backed by S3/EBS.
    - **Tape Gateway:** A virtual tape library for backup, backed by S3/Glacier.