...
- **When Do We Use a Firewall? (WAF vs. Other Firewalls)**
    ...
    | **What it Inspects** | **Layer 7:** The *content* of the HTTP request (URL, headers, body). | **Layer 3/4:** The *source/destination IP address* and *port number*. | **Layers 3-7:** IP, Port, and can do deep packet inspection of the content. |
